                ...
                <div className="flex justify-between items-center h-16">
                    <div className="flex items-center space-x-8">
                        ...
                        <nav className="hidden md:flex space-x-1">
                            <a href="#" onClick={() => onNavigate('home')} className="px-3 py-2 rounded-md text-sm font-medium text-gray-700 hover:bg-gray-100 hover:text-gray-900">Home</a>
                            {canViewDashboards && (
                                <Dropdown trigger={<button className="px-3 py-2 rounded-md text-sm font-medium text-gray-700 hover:bg-gray-100 hover:text-gray-900">Dashboards</button>}>
                            ...
                            {canAddPosting && <a href="#" onClick={() => onNavigate('new_posting')} className="px-3 py-2 rounded-md text-sm font-medium text-gray-700 hover:bg-gray-100 hover:text-gray-900">New Posting</a>}
                            {canViewCandidates && <a href="#" onClick={() => onNavigate('candidate_details')} className="px-3 py-2 rounded-md text-sm font-medium text-gray-700 hover:bg-gray-100 hover:text-gray-900">Candidates</a>}
                            {canViewReports && <a href="#" onClick={() => onNavigate('reports')} className="px-3 py-2 rounded-md text-sm font-medium text-gray-700 hover:bg-gray-100 hover:text-gray-900">Reports</a>}
                            {canMessage && <a href="#" onClick={() => onNavigate('messages')} className="px-3 py-2 rounded-md text-sm font-medium text-gray-700 hover:bg-gray-100 hover:text-gray-900">Messages</a>}
                            {canManageTimesheets && (
                                <Dropdown trigger={<button className="px-3 py-2 rounded-md text-sm font-medium text-gray-700 hover:bg-gray-100 hover:text-gray-900">Timesheets</button>}>
                                    <a href="#" onClick={() => onNavigate('create_timesheet_company')} className="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100">Create Company</a>
                                    ...
                                    <a href="#" onClick={() => onNavigate('create_timesheet_employee')} className="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100">Create Timesheet Employee</a>
                            ...
                            {(canManageMSAWO || canManageOfferLetters) && (
                                <Dropdown trigger={<button className="px-3 py-2 rounded-md text-sm font-medium text-gray-700 hover:bg-gray-100 hover:text-gray-900">E-Sign's</button>}>
                                    {canManageMSAWO && <span className="px-4 py-2 text-xs font-semibold text-gray-500 uppercase">MSA & WO</span>}
                                    {canManageMSAWO && <a href="#" onClick={() => onNavigate('create_msawo_vendor_company')} className="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 pl-6">Create Vendor Company</a>}
                                    {canManageMSAWO && <a href="#" onClick={() => onNavigate('manage_msawo_vendor_companies')} className="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 pl-6">Manage Vendor Companies</a>}
                                    {canManageMSAWO && <a href="#" onClick={() => onNavigate('create_msa_wo')} className="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 pl-6">Create MSA/WO</a>}
                                    {canManageMSAWO && <a href="#" onClick={() => onNavigate('msa_wo_dashboard')} className="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 pl-6">MSA/WO Dashboard</a>}
                                    
                                    {canManageOfferLetters && <span className="mt-2 border-t block px-4 py-2 text-xs font-semibold text-gray-500 uppercase">Offer Letter</span>}
                                    {canManageOfferLetters && <a href="#" onClick={() => onNavigate('create_offer_letter')} className="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 pl-6">Create Offer Letter</a>}
                                    {canManageOfferLetters && <a href="#" onClick={() => onNavigate('offer_letter_dashboard')} className="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 pl-6">Offer Letter Dashboard</a>}
                                </Dropdown>
                            )}
                            {canEditUsers && <a href="#" onClick={() => onNavigate('admin')} className="px-3 py-2 rounded-md text-sm font-medium text-gray-700 hover:bg-gray-100 hover:text-gray-900">Admin</a>}
                        </nav>
                    </div>

    ...
    return (
        <div className="space-y-6">
            <div>
                ...
                <p className="mt-1 text-gray-600">Add details for a new client company.</p>
            </div>
            {!canManageTimesheets && !loading && (
                <div className="text-center text-gray-500 p-10 bg-white rounded-xl shadow-sm border">
                    <h3 className="text-lg font-medium">Access Denied</h3>
                    <p className="text-sm">You do not have the necessary permissions to create companies.</p>
                </div>
            )}
            {canManageTimesheets && (
                    ...
                    <div className="bg-white p-6 md:p-8 rounded-xl shadow-sm border">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-x-6 gap-y-6">
                            <div>
                                ...
                                <input type="text" name="companyName" id="companyName" value={formData.companyName} onChange={handleChange} required className="mt-1 block w-full border border-gray-300 rounded-lg shadow-sm p-2 focus:ring-indigo-500 focus:border-indigo-500" />
                            </div>
                            <div>

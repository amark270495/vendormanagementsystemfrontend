            ...
            <div className="bg-white p-6 md:p-8 rounded-xl shadow-sm border text-center text-gray-500">
                 {!canManageOfferLetters ? (
                     <div className="p-10">
                        ...
                        <p className="mt-1 text-sm">You do not have the necessary permissions to view the offer letter dashboard.</p>
                    </div>
                ) : (
                    <div className="p-10">
                        <h3 className="text-lg font-medium">Under Construction</h3>
                        <p className="mt-1 text-sm ">The dashboard to track the status of all offer letters will be available here shortly.</p>
                    </div>
                )}
            </div>
        </div>
